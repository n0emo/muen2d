...
static inline auto get_sound(::JSContext *js, ::JSValueConst val) -> Sound * {
    auto sound = static_cast<Sound *>(JS_GetOpaque(val, sound_class_id(js)));
    assert(sound);
    return sound;
}
...
const static ::std::array proto_funcs = {
